              ...
              <div className="col-md-6 mt-3">
                <div className="card">
                  ...
                  <div className="card-body">
                    <div className="row">
                      <h5 className="card-title col-sm-5">
                        Name: {ac.ServiceProvider_Username}
                      </h5>
                      <h5 className="card-title col-sm-7">
                        MobileNo: {ac.MobileNo}
                      </h5>
                    </div>
                    <div className="row">
                      <h5 className="card-title col-sm-5">
                        Average Price: {ac.Price}
                      </h5>
                      <h5 className="card-title col-sm-7">
                        Gender: {ac.Gender}
                      </h5>
                    ...
                    <div className="row">
                      <h5 className="card-title col-sm-5">City: {ac.City}</h5>
                      <h5 className="card-title col-sm-7">
                        Occupation: {ac.Occupation}
                      </h5>
                    </div>
                    <div className="row">
                      <h5 className="card-title col-sm-12">
                        EmailID: {ac.email}
                      </h5>
                    </div>
                    <div className="row">
                    ...
                    <div className="row">
                      <div className="col-sm-12">
                        <Link
                          to={`/Customer/Booking/${ac.ServiceProvider_Username}`}
                        >
