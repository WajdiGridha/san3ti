...
function SignupForm(props) {
  ...
  const errors = validate(
    ...
    initialState.repassword,
    initialState.Name,
    initialState.MobileNo,
    initialState.Email,
    initialState.City
  );
  ...
  const base = (
    <>
      <Card className="mt-5 mb-5">
        <CardHeader className="color mt-3 d-flex justify-content-start ">
            ...
            <Form onSubmit={handleSubmitClick}>
              ...
              <FormGroup>
                ...
                <Input
                  required
                  type="select"
                  name="customer_or_service_provider"
                  id="customer_or_service_provider"
                  value={initialState.customer_or_service_provider}
              ...
              <button
                type="submit"
                value="submit"
                className="color btn btn-primary btn-md btn-block mt-2"
              >
                <span className="fa fa-sign-in-alt fa-lg"></span>Sign-up
              </button>
            </Form>
          </CardBody>
        }
    ...
    return (
      <>
        ...
        >
          <h1
            className="lead"
            style={{ fontSize: "280%", fontWeight: "bolder" }}
          >
            FILL INFORMATION
          </h1>
        </Jumbotron>
        <div className="row container-fluid">
          <div className="col-7">{base}</div>
          <div className="col-5">
            <Card className=" mt-5 mb-5 ">
              <CardHeader className="color mt-3 d-flex justify-content-start">
                <h4 className=" mt-2 " style={{ fontSize: "70%" }}>
  ...
  return (
    <>
      <Jumbotron
        style={{
          backgroundImage: `url(https://ps.w.org/ultimate-member/assets/banner-772x250.png?rev=2143172)`,
          backgroundSize: "70%",
          paddingTop: "10%",
          paddingBottom: "11%",
          backgroundRepeat: "no-repeat",
      ...
      <div className="row container-fluid">
        ...
        <div className="offset-2 col-md-6">{base}</div>
      </div>
    </>
  );
}
