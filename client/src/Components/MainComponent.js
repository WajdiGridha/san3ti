...
const mapDispatchToProps = (dispatch) => ({
  ...
  postServiceProvider: (serviceProvider) =>
    dispatch(postServiceProvider(serviceProvider)),
  ...
  updateServiceProviderInfo: (serviceProvider) =>
    dispatch(updateServiceProviderInfo(serviceProvider)),
      ...
      <div>
        ...
        <Switch>
          ...
          <ServiceProviderRoute
            ...
            component={() => (
              <ServiceProviderMainComponent
                ...
                updateServiceProviderInfo={this.props.updateServiceProviderInfo}
              />
            )}
          />
          <CustomerRoute
          ...
          <Route
            ...
            component={() => (
              <SignupForm
                postCustomer={this.props.postCustomer}
                postServiceProvider={this.props.postServiceProvider}
              />
            )}
          />
          ...
          <Route
            ...
            component={() => (
              <PlumberView
                plumbers={this.props.serviceProviders.serviceproviders.filter(
                  (sp) => sp.Occupation === "Plumber"
                )}
              />
            )}
          />
          <Route
            ...
            component={() => (
              <ApplianceView
                appliances={this.props.serviceProviders.serviceproviders.filter(
                  (sp) => sp.Occupation === "Appliance Repair"
                )}
              />
            )}
          />
          <Route
            ...
            component={() => (
              <CarpenterView
                carpenters={this.props.serviceProviders.serviceproviders.filter(
                  (sp) => sp.Occupation === "Carpenter"
                )}
              />
            )}
          />
          <Route
            ...
            component={() => (
              <BarberView
                barbers={this.props.serviceProviders.serviceproviders.filter(
                  (sp) => sp.Occupation === "Barber"
                )}
              />
            )}
          />
          <Route
            ...
            component={() => (
              <ACView
                acrepairs={this.props.serviceProviders.serviceproviders.filter(
                  (sp) => sp.Occupation === "AC Service/Repair"
                )}
              />
            )}
          />
          <Route
            path="/ElectricianView"
            component={() => (
              <ElectricianView
                electricians={this.props.serviceProviders.serviceproviders.filter(
                  (sp) => sp.Occupation === "Electrician"
                )}
              />
            )}
          />
