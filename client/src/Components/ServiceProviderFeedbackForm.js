    ...
    if (typeof this.props.booking_details !== "undefined") {
      let updated_booking = {
        ...
        ServiceProviders_Username:
          this.props.booking_details.ServiceProviders_Username,
        ...
        <div>
          <Form className="myForm container-fluid" onSubmit={this.handleSubmit}>
            <Row form>
              <Col md={4}>
                <FormGroup>
                  <Label for="ServiceProvider_Username">
                    ServiceProvider Username
                  </Label>
                  <Input
                    required
                    type="text"
                    name="ServiceProvider_Username"
                    id="ServiceProvider_Username"
                    value={this.state.ServiceProvider_Username}
