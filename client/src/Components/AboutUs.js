          ...
          <div className="row">
            <div className="col-sm-6">
              ...
              <div className="row container-fluid">
                <p>
                  SAN3TI provides local service providers a platform to provide
                  services to the customer and increase their reach. It also
                  helps customers book reliable home services like beauty
                  services, massage therapy, cleaning, plumbing,carpentry,
                  appliance repair, painting etc to empower millions of service
                  professionals across the world to deliver services at home
                  like never before.
                </p>
                <p>
                  Once on the platform, our match-making algorithm identifies
                  which service provider are closest to the users' requirements
                  and available at the requested time and date.
                </p>
              </div>
            </div>
                  ...
                  <div className="col-md-3 mt-1">
                    <div className="card">
                      <div className="card-body">
                        ...
                        <a
                          href="https://linkedin.com/in/wajdi-gridha-b034471b4"
                          target="_blank"
                        >
                          <i
                        ...
                        <a
                          href="https://github.com/WajdiGridha"
                          target="_blank"
                        >
                          <i
                            style={{ color: "black" }}
                  ...
                  <div className="col-md-3 mt-1">
                    <div className="card">
                      <div className="card-body">
                        ...
                        <p className="card-text">Full Stack Web Developer</p>
                        <a
                          href="https://www.linkedin.com/in/amine-kahlaoui-8689491b9/"
                          target="_blank"
                        >
                          <i
                            className="fab fa-linkedin-square fa-2x"
                        ...
                        <a
                          href="https://github.com/kahlaoui-amine"
                          target="_blank"
                        >
                          <i
                            style={{ color: "black" }}
